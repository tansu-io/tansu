...
taxi-topic-create: (topic-create "taxi" "--partitions" "1" "--config" "'tansu.lake.generate.date=cast(timestamp as date)'" "--config" "tansu.lake.partition=date,partition" "--config" "tansu.lake.z_order=vendor_id" "--config" "tansu.lake.sink=true")
