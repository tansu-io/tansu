...
mod json {
    ...
    async fn key_and_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| meta                                                     | key   | value                                   |",
            "+----------------------------------------------------------+-------+-----------------------------------------+",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 12321 | {email: alice@example.com, name: alice} |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 32123 | {email: bob@example.com, name: bob}     |",
            "+----------------------------------------------------------+-------+-----------------------------------------+",
        ];
    ...
    async fn grade() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| meta                                                     | key         | value                                                                                                         |",
            "+----------------------------------------------------------+-------------+---------------------------------------------------------------------------------------------------------------+",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 123-45-6789 | {final: 49.0, first: Aloysius, grade: D-, last: Alfalfa, test1: 40.0, test2: 90.0, test3: 100.0, test4: 83.0} |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 123-12-1234 | {final: 48.0, first: University, grade: D+, last: Alfred, test1: 41.0, test2: 97.0, test3: 96.0, test4: 97.0} |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 567-89-0123 | {final: 44.0, first: Gramma, grade: C, last: Gerty, test1: 41.0, test2: 80.0, test3: 60.0, test4: 40.0}       |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 087-65-4321 | {final: 47.0, first: Electric, grade: B-, last: Android, test1: 42.0, test2: 23.0, test3: 36.0, test4: 45.0}  |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 456-78-9012 | {final: 45.0, first: Fred, grade: A-, last: Bumpkin, test1: 43.0, test2: 78.0, test3: 88.0, test4: 77.0}      |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 234-56-7890 | {final: 46.0, first: Betty, grade: C-, last: Rubble, test1: 44.0, test2: 90.0, test3: 80.0, test4: 90.0}      |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 345-67-8901 | {final: 43.0, first: Cecil, grade: F, last: Noshow, test1: 45.0, test2: 11.0, test3: -1.0, test4: 4.0}        |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 632-79-9939 | {final: 50.0, first: Bif, grade: B+, last: Buff, test1: 46.0, test2: 20.0, test3: 30.0, test4: 40.0}          |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 223-45-6789 | {final: 83.0, first: Andrew, grade: A, last: Airpump, test1: 49.0, test2: 1.0, test3: 90.0, test4: 100.0}     |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 143-12-1234 | {final: 97.0, first: Jim, grade: A+, last: Backus, test1: 48.0, test2: 1.0, test3: 97.0, test4: 96.0}         |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 565-89-0123 | {final: 40.0, first: Art, grade: D+, last: Carnivore, test1: 44.0, test2: 1.0, test3: 80.0, test4: 60.0}      |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 087-75-4321 | {final: 45.0, first: Jim, grade: C+, last: Dandy, test1: 47.0, test2: 1.0, test3: 23.0, test4: 36.0}          |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 456-71-9012 | {final: 77.0, first: Ima, grade: B-, last: Elephant, test1: 45.0, test2: 1.0, test3: 78.0, test4: 88.0}       |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 234-56-2890 | {final: 90.0, first: Benny, grade: B-, last: Franklin, test1: 50.0, test2: 1.0, test3: 90.0, test4: 80.0}     |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 345-67-3901 | {final: 4.0, first: Boy, grade: B, last: George, test1: 40.0, test2: 1.0, test3: 11.0, test4: -1.0}           |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 632-79-9439 | {final: 40.0, first: Harvey, grade: C, last: Heffalump, test1: 30.0, test2: 1.0, test3: 20.0, test4: 30.0}    |",
            "+----------------------------------------------------------+-------------+---------------------------------------------------------------------------------------------------------------+",
        ];
    ...
    async fn key() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| meta                                                     | key   |",
            "+----------------------------------------------------------+-------+",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 12321 |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 23432 |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 34543 |",
            "+----------------------------------------------------------+-------+",
        ];
    ...
    async fn primitive_key_and_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| meta                                                     | key   | value             |",
            "+----------------------------------------------------------+-------+-------------------+",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 12321 | alice@example.com |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 32123 | bob@example.com   |",
            "+----------------------------------------------------------+-------+-------------------+",
        ];
    ...
    async fn primitive_key_and_array_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| meta                                                     | key   | value     |",
            "+----------------------------------------------------------+-------+-----------+",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 12321 | [a, b, c] |",
            "| {partition: 32123, timestamp: 2009-02-13T23:31:30+00:00} | 32123 | [p, q, r] |",
            "+----------------------------------------------------------+-------+-----------+",
        ];
...
mod avro {
    ...
    async fn record_of_primitive_data_types() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value                                                                                                                  | meta                                                                 |",
            "+------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------+",
            "| {b: false, c: 2147483647, d: 9223372036854775807, e: 3.4028235e38, f: 1.7976931348623157e308, g: 616263646566, h: pqr} | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn record_of_with_list_of_primitive_data_types() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value                                                                                                                                                                                                                                           | meta                                                                 |",
            "+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------+",
            "| {b: [false, true], c: [-2147483648, 0, 2147483647], d: [-9223372036854775808, 0, 9223372036854775807], e: [-3.4028235e38, 0.0, 3.4028235e38], f: [-1.7976931348623157e308, 0.0, 1.7976931348623157e308], g: [616263646566], h: [abc, pqr, xyz]} | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn union() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value         | meta                                                                 |",
            "+---------------+----------------------------------------------------------------------+",
            "| -3.4028235e38 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "|               | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| 3.4028235e38  | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+---------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn enumeration() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value  | meta                                                                 |",
            "+--------+----------------------------------------------------------------------+",
            "| CLUBS  | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| HEARTS | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+--------+----------------------------------------------------------------------+",
        ];
    ...
    async fn observation_enumeration() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| key                                  | value                         | meta                                                                 |",
            "+--------------------------------------+-------------------------------+----------------------------------------------------------------------+",
            "| 1e44d9c2-5e7a-443b-bf10-2b1e5fd72f15 | {amount: 23.2, unit: CELSIUS} | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+--------------------------------------+-------------------------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn simple_integer_key() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| key   | meta                                                                 |",
            "+-------+----------------------------------------------------------------------+",
            "| 32123 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| 45654 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| 87678 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| 12321 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+-------+----------------------------------------------------------------------+",
        ];
    ...
    async fn simple_record_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value                                 | meta                                                                 |",
            "+---------------------------------------+----------------------------------------------------------------------+",
            "| {id: 32123, name: alice, lucky: [6]}  | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| {id: 45654, name: bob, lucky: [5, 9]} | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+---------------------------------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn array_bool_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value          | meta                                                                 |",
            "+----------------+----------------------------------------------------------------------+",
            "| [true, true]   | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| [false, true]  | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| [true, false]  | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| [false, false] | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+----------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn array_int_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value                        | meta                                                                 |",
            "+------------------------------+----------------------------------------------------------------------+",
            "| [32123, 23432, 12321, 56765] | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| [-2147483648, 2147483647]    | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+------------------------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn array_long_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "+---------------------------------------------+----------------------------------------------------------------------+",
            "| [32123, 23432, 12321, 56765]                | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| [-9223372036854775808, 9223372036854775807] | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+---------------------------------------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn array_float_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value                            | meta                                                                 |",
            "+----------------------------------+----------------------------------------------------------------------+",
            "| [3.2123, 23.432, 123.21, 5676.5] | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| [-3.4028235e38, 3.4028235e38]    | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+----------------------------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn array_double_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "+---------------------------------------------------+----------------------------------------------------------------------+",
            "| [3.2123, 23.432, 123.21, 5676.5]                  | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| [-1.7976931348623157e308, 1.7976931348623157e308] | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+---------------------------------------------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn array_string_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value           | meta                                                                 |",
            "+-----------------+----------------------------------------------------------------------+",
            "| [abc, def, pqr] | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| [xyz]           | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+-----------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn array_bytes_value() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value                    | meta                                                                 |",
            "+--------------------------+----------------------------------------------------------------------+",
            "| [616263, 646566, 707172] | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| [3534333435]             | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+--------------------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn uuid_logical_type() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value                                | meta                                                                 |",
            "+--------------------------------------+----------------------------------------------------------------------+",
            "| 383bb977-7d38-42b5-8be7-58a1c606de7a | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| 2c1fddc8-4ebe-43fd-8f1c-47e18b7a4e21 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| f9b45334-9aa2-4978-8735-9800d27a551c | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+--------------------------------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn time_micros_logical_type() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value           | meta                                                                 |",
            "+-----------------+----------------------------------------------------------------------+",
            "| 00:00:00.000001 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| 00:00:00.000002 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| 00:00:00.000003 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+-----------------+----------------------------------------------------------------------+",
        ];
    ...
    async fn timestamp_micros_logical_type() -> Result<()> {
        ...
        let expected = vec![
            ...
            "| value               | meta                                                                 |",
            "+---------------------+----------------------------------------------------------------------+",
            "| 1973-10-17T18:36:57 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| 2001-09-09T01:46:40 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "| 2009-02-13T23:31:30 | {partition: 32123, timestamp: 2009-02-13T23:31:30, date: 2009-02-13} |",
            "+---------------------+----------------------------------------------------------------------+",
        ];
